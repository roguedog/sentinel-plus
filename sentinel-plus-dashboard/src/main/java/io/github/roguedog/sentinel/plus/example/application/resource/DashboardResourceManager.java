package io.github.roguedog.sentinel.plus.example.application.resource;
...
import io.github.roguedog.sentinel.plus.example.application.entity.MetricEntity;
import io.github.roguedog.sentinel.plus.example.entrypoint.common.CommonEntryPoint;
...
public class DashboardResourceManager {
    ...
    private static class LocalDashboardMetricFetcherService {
        ...
        private String appName = "sentinel-io.github.rd.sentinel.dashboard";
