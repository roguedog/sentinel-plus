...
public class DashboardResourceManager {
    ...
    public void fetchLocalMetric() {
        localDashboardMetricFetcherService.fetch();
    }

    public long getFetchLocalMetricPeriodSchedulerSeconds() {
        return fetchLocalMetricPeriodSchedulerSeconds;
    }
